    ...
    <div class="container-fluid">
        <header class="separar-extremos">
            ...
            <nav class="nav navbar-expand-lg ">
                <a class="a-color-blanco btn-hover btn-rojo btn-g centrar top-c " href="Autenticar.php">Iniciar Sesion</a>
            </nav>
        </header>
        ...
        <main class="centrar">
            <div class="cuadro-formulario-m relative radius box-sombra-blanco">
                <div class="centrar">
                    <h1 id="titulo-formulario">Registrarse</h1>
                </div>
                <form class="formulario" action="../../servidor/RegistrarUsuariosbd.php" method="post">
                    ...
                    <button type="submit" id="btn-registrar" class="btn-hover btn-g btn-rojo">Registrarse</button>
                </form>
                <img src="../img/avatar-danyi.png" alt="avatar-danyi" id="avatar" class="avatar-usuario">
            </div>
        </main>
    </div>
