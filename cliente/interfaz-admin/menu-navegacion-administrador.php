            ...
            <nav class="nav navbar-expand-lg ">
                ...
                <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="../Formularios/RegistrarProveedores.php">Registrar Proveedores</a>
                            <a href="../Formularios/RegistrarRepartidores.php">Registrar Repartidores</a>
                            <a href="../Formularios/RegistrarCategoria.php">Registrar Categorias</a>
                            <a href="../Formularios/RegistrarProductos.php">Registrar Productos</a>
                        </div>
                    </div>
